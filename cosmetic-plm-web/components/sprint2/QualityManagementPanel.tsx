...
// 입력), "시험성적서"(반제품/완제품 시험성적서 작성 및 PDF/엑셀 출력)를 서브탭으로 묶는다. 홈에서 특정
// 시료의 "열기"를 누르면 시료 목록 탭으로 전환되면서 그 시료가 바로 선택된다.
export default function QualityManagementPanel() {
  const [tab, setTab] = useState<"home" | "list" | "certificate">("home");
