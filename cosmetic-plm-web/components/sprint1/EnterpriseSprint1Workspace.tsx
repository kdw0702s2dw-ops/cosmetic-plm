      ...
      <div className="v50-shell">
        <aside className="v50-sidebar">
          <div className="v50-brand">
            ...
            <div className="v50-brand-sub">실시간 연구원 Workspace</div>
          </div>
          ...
          <nav className="v50-menu">
            ...
            <div>
              ...
              <div style={{ padding: "10px 12px", color: "#475569", fontSize: 13, lineHeight: 1.6 }}>
                <strong>{auth.profile?.email}</strong><br />역할: {auth.profile?.role}
              </div>
        ...
        <main className="v50-main">
          <header className="v50-topbar">
            <input className="v50-search" placeholder="실시간 연구원 홈, 원료, 처방, 문서 PDF를 DB 기준으로 사용합니다." readOnly />
            <div className="v50-top-actions">
              ...
              <button className="v50-button" onClick={() => setActive("docs")}>문서관리</button>
            </div>
          </header>
