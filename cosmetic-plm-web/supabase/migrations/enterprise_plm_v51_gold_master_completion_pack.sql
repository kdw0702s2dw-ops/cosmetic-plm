-- Enterprise PLM v5.1 GOLD MASTER Completion Pack
-- Completion dashboard marker only.
...
values
('V5.1-GOLD-MASTER-COMPLETION', 'Enterprise PLM v5.1 GOLD MASTER Completion Pack', 'Adds final Korean GOLD MASTER completion dashboard and direct route for operational readiness checks.')
