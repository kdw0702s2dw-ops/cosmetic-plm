-- Enterprise PLM v5.1 System Health & QA Pack
-- UI + operation health marker only.
...
values
('V5.1-SYSTEM-HEALTH-QA', 'Enterprise PLM v5.1 System Health & QA Pack', 'Adds Korean system health dashboard for core tables, smart formula runs, release readiness runs, documents, batches and release markers.')
