-- Enterprise PLM v5.0 Formula PRO Activation Pack
...
values
('V5.0-FORMULA-PRO-ACTIVATION', 'Enterprise PLM v5.0 Formula PRO Activation Pack', 'Activates FormulaWorkspaceProPanel as the default Formula screen in GoldUxWorkspace.')
