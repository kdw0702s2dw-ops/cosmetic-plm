-- Enterprise PLM v5.0 Document & Manufacturing PRO Pack
-- Adds release marker only. Requires existing gold_documents and gold_manufacturing_* tables.
...
values
('V5.0-DOC-MFG-PRO', 'Enterprise PLM v5.0 Document & Manufacturing PRO Pack', 'Adds Korean PRO panels for document package generation and manufacturing batch workflow.')
