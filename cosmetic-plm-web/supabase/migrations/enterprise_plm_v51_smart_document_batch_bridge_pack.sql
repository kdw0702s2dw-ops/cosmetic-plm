-- Enterprise PLM v5.1 Smart Document & Batch Bridge Pack
-- Adds release marker only.
...
values
('V5.1-SMART-DOC-BATCH-BRIDGE', 'Enterprise PLM v5.1 Smart Document & Batch Bridge Pack', 'Connects Smart Formula Engine results to smart document packages and scaled manufacturing batches. MES and ERP integrations excluded.')
