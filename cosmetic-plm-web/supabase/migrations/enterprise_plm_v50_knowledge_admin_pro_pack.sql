-- Enterprise PLM v5.0 Knowledge & Admin PRO Pack
...
values
('V5.0-KNOWLEDGE-ADMIN-PRO', 'Enterprise PLM v5.0 Knowledge & Admin PRO Pack', 'Adds Korean PRO panels for Knowledge DB and Admin system operation.')
