-- Enterprise PLM v5.1 Smart Formula Engine Activation Pack
...
values
('V5.1-SMART-FORMULA-ACTIVATION', 'Enterprise PLM v5.1 Smart Formula Engine Activation Pack', 'Activates Smart Formula Engine in the v5.1 Korean workspace menu.')
