...
-- If audit_logs already existed from an older phase, CREATE TABLE IF NOT EXISTS
-- does not add missing columns. Add them safely before creating indexes/policies.
