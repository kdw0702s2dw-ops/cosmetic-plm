-- Enterprise PLM v5.1 Production Polish Pack
-- UI polish and stability marker only.
...
values
('V5.1-PRODUCTION-POLISH', 'Enterprise PLM v5.1 Production Polish Pack', 'Adds loading, error fallback, usage guide and production UI stability helpers for v5.1 workspace.')
