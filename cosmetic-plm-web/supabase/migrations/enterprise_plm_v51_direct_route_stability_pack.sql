-- Enterprise PLM v5.1 Direct Route & Stability Pack
-- UI route/stability marker only.
...
values
('V5.1-DIRECT-ROUTE-STABILITY', 'Enterprise PLM v5.1 Direct Route & Stability Pack', 'Adds direct routes for Smart Formula, Smart Bridge, Release Readiness and System Health with Korean standalone shell and stability helpers.')
