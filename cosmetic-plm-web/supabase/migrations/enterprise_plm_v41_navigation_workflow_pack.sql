-- Enterprise PLM v4.1 Navigation & Workflow Pack
...
values
('V4.1-NAV-WORKFLOW', 'Enterprise PLM v4.1 Navigation & Workflow Pack', 'Adds workflow center and connects AI, Formula, Validation, Cost, Intelligence, Documents, Release, Manufacturing.')
