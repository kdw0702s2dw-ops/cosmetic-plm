-- Enterprise PLM v5.0 Knowledge & Admin PRO Activation Pack
...
values
('V5.0-KNOWLEDGE-ADMIN-ACTIVATION', 'Enterprise PLM v5.0 Knowledge & Admin PRO Activation Pack', 'Activates KnowledgeProPanel and AdminProPanel as default v5.0 workspace screens.')
