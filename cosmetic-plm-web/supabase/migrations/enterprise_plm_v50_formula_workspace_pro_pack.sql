-- Enterprise PLM v5.0 Formula Workspace PRO Pack
-- Adds release marker only. Requires existing gold_* tables.
...
values
('V5.0-FORMULA-WORKSPACE-PRO', 'Enterprise PLM v5.0 Formula Workspace PRO Pack', 'Adds one-screen formula workflow: validation, cost, score and document package generation from v5.0 formula workspace.')
